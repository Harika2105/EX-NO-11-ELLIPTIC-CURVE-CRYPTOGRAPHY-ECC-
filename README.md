...
int main() {
    ...
    printf("Enter Dhinesh's private key: ");
    scanf("%lld", &privateA);
    printf("Enter Dhinesh's private key: ");
    scanf("%lld", &privateB);
    ...
    printf("Dhinesh's public key: (%lld, %lld)\n", publicA.x, publicA.y);
    printf("Dhinesh's public key: (%lld, %lld)\n", publicB.x, publicB.y);
    ...
    printf("Shared secret computed by Dhinesh: (%lld, %lld)\n", sharedSecretA.x, sharedSecretA.y);
...
```
## Output:
<img width="1012" height="521" alt="Screenshot 2026-03-19 111948" src="https://github.com/user-attachments/assets/f74bbb0f-2eec-45a4-8f66-80305e3f26b0" />
